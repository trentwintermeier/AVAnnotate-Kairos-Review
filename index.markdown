...
<br><br>
This webtext is organized according to these categories: [infrastructure](https://trentwintermeier.github.io/AVAnnotate-Kairos-Review/infrastructure), [audio](https://trentwintermeier.github.io/AVAnnotate-Kairos-Review/audio), [annotation](https://trentwintermeier.github.io/AVAnnotate-Kairos-Review/annotation), [context](https://trentwintermeier.github.io/AVAnnotate-Kairos-Review/context), [collaboration](https://trentwintermeier.github.io/AVAnnotate-Kairos-Review/collaboration), and finally a [conclusion](https://trentwintermeier.github.io/AVAnnotate-Kairos-Review/conclusion). Each section includes audio I've recorded, which includes the main content of the review. Annotations accompany each audio recording, expanding as necessary on certain topics, concepts, or experiences which are in the review. Otherwise, the section titled ["Application"](https://trentwintermeier.github.io/AVAnnotate-Kairos-Review/application} applies AVAnnotate in a classroom setting by using external audio as an example. Navigation of both the annotations and audio can be done in the player or by clicking the annotations. Users may navigate the review through the layers provided in the third column; these serve to conceptually organize the content of the webtext.
      </div>
    </td>
